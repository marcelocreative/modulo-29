...
import br.com.mgsystems.dao.jdbc.ConnectionFactory;
...
public class ProdutoDAO implements IProdutoDAO {
	...
	public List<Produto> buscarTodos() throws Exception {
		...
		try {
		    ...
		    while (rs.next()) {
		    	...
		    	String cd = rs.getString("CODIGO");
		    	String marca = rs.getString("MARCA");
		    	String forcenedor = rs.getString("FORNECEDOR");
		    	produto.setId(id);
		    	produto.setNome(nome);
		    	produto.setCodigo(cd);
		    	produto.setMarca(marca);
		    	produto.setFornecedor(forcenedor);
		    	list.add(produto);
		    }
		} catch(Exception e) {
			throw e;
	...
	private String getSqlInsert() {
		...
		sb.append("INSERT INTO TB_PRODUTO (ID, CODIGO, NOME, MARCA, FORNECEDOR) ");
	...
	private String getSqlUpdate() {
		...
		sb.append("SET NOME = ?, CODIGO = ?, MARCA = ?, FORNECEDOR = ? ");
		sb.append("WHERE ID = ?");
		return sb.toString();
	}
